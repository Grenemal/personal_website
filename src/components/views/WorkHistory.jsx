...
const WorkHistory = () => {
  ...
  const workExperience = [
    ...
    {
      company: '聚集诱导发光高等研究院',
      position: '总监/副总监/中心主任/中心副主任/项目经理',
    ...
    {
      company: '南方医科大学深圳医院/深圳大学物理与光电学院',
      position: '博士后',
      period: '2017.07 – 2021.11',
      achievements: [
        { text: '南方医-氢分子生物荧光探针的开发及其药代动力学研究', icon: <FaCode /> },
        { text: '深圳大学-活细胞超分辨荧光成像材料的开发', icon: <FaCode /> },
      ]
    },
  ];
